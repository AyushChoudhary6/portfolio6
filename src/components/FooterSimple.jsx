...
const Footer = () => {
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/ayush-choudhary-29aa01325/',
      icon: (
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/AyushChoudhary6',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="py-12">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-left mb-6 md:mb-0">
              <h3 className="text-2xl font-bold mb-2">Ayush Choudhary</h3>
              <p className="text-gray-400">DevOps Engineer</p>
            </div>

            {/* Navigation Links */}
            <div className="flex flex-wrap justify-center md:justify-end gap-8 mb-6 md:mb-0">
          ...
          <div className="border-t border-gray-800 pt-8 mt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-gray-400 text-sm mb-4 md:mb-0">
                © {currentYear} Ayush Choudhary. All rights reserved.
              </p>
