...
const CampingLoader = () => {
  return (
    <div className="camping-scene-wrapper">
      <style jsx>{`
  ...
  React.useEffect(() => {
    const interval = setInterval(() => {
      setProgress(prev => {
        ...
        return prev + 2.5; // Increase by 2.5% every 75ms to reach 100% in 3 seconds
      });
    }, 75);
...
const LoadingScreen = ({ onComplete }) => {
  ...
  useEffect(() => {
    // Show camping scene for 4 seconds
  ...
  return (
    <AnimatePresence>
      ...
      >
        <CampingLoader />
        {/* Loading bar in bottom right corner */}
